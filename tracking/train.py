...
def parse_args():
    ...
    # for train
    parser.add_argument('--script', type=str, default='seqtrackv2', help='training script name')
    parser.add_argument('--config', type=str, default='seqtrackv2_b256', help='yaml configure file name')
