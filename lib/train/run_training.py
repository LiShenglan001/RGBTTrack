...
def main():
    ...
    parser.add_argument('--script', type=str, default='seqtrackv2', help='Name of the train script.')
    parser.add_argument('--config', type=str, default='seqtrackv2_b256', help="Name of the config file.")
